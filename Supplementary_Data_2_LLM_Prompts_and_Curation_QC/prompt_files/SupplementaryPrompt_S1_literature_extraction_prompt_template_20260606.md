...
- Source type represented here: `Literature`
...
Current source type: Literature
...
- Use article-language evidence only. If the paper is a review, extract only named constructs with explicit quantitative or structural support.
...
```text
Extract database-ready structured entries from the following Literature text.
